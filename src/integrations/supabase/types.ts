...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      collection_report: {
        Row: {
          blockedcustomersjson: string | null
          collectedamount: number
          currentamount: number
          currentcount: number
          heldordersjson: string | null
          id: number
          lastupdated: number
          monthlygoal: number
          percentage: number
          range1to30amount: number
          range1to30count: number
          range31to60amount: number
          range31to60count: number
          rangeover60amount: number
          rangeover60count: number
          upcomingduedatesjson: string | null
        }
        Insert: {
          blockedcustomersjson?: string | null
          collectedamount: number
        ...
        Relationships: [
          {
            ...
            columns: ["document_id"]
            isOneToOne: false
            referencedRelation: "indice_documentos_visual"
            referencedColumns: ["id"]
          },
          {
            ...
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "user_visual"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      leader_config_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "leader_config_categories_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
      ...
      maya_candidates: {
        ...
        Relationships: [
          {
            foreignKeyName: "maya_candidates_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "maya_agents"
            referencedColumns: ["id"]
          },
        ]
      }
      maya_interview_reports: {
        Row: {
          agent_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "maya_interview_reports_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "maya_agents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "maya_interview_reports_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "maya_candidates"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      pi_plan_activities: {
        ...
        Relationships: [
          {
            foreignKeyName: "pi_plan_activities_plan_id_fkey"
            columns: ["plan_id"]
            isOneToOne: false
            referencedRelation: "pi_plans"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      tariff_classifications: {
        Row: {
          ...
          posicion_descripcion: string | null
      ...
      viaje_user_roles: {
        Row: {
          created_at: string
          id: string
          role: Database["public"]["Enums"]["viaje_role"]
          user_id: string
        }
        Insert: {
          created_at?: string
    ...
    Functions: {
      ...
      bump_stock_usage: { Args: { _ids: string[] }; Returns: undefined }
      can_access_comercial: { Args: never; Returns: boolean }
      ...
      get_pi_user_role: { Args: { _user_id: string }; Returns: string }
      get_pi_users: {
        Args: never
        Returns: {
          created_at: string
      ...
      get_viaje_role: { Args: { _user_id: string }; Returns: string }
      ...
      has_viaje_role: {
        Args: {
          _role: Database["public"]["Enums"]["viaje_role"]
          _user_id: string
        }
        Returns: boolean
      }
      ...
      require_comercial_access: { Args: never; Returns: undefined }
      ...
      update_ticket_from_n8n: {
        Args: {
          p_ai_category: string
          p_ai_priority: string
          p_original_ticket_id: string
          p_run_id: string
        }
        Returns: undefined
      }
      ...
      validar_anti_canibalizacion: {
        Args: {
          p_articulo_ids: string[]
          p_cliente_id: string
    ...
    Enums: {
      ...
      user_role:
        ...
        | "usuario"
        | "admin_ventas"
      viaje_role: "administrador" | "gerente" | "personal"
    }
    CompositeTypes: {
      [_ in never]: never
    }
